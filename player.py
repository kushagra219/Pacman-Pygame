...
player_img = pygame.image.load(resource_path('assets/pacman-player.png'))
player_shrink_img = pygame.transform.scale(player_img, (18, 18))
chomp_sound = pygame.mixer.Sound(resource_path('assets/pacman_chomp.wav'))
chomp_sound.set_volume(0.5)
enemy_intermission_img = pygame.transform.scale(pygame.image.load(resource_path('assets/enemy_intermission.jpg')), (18, 18))

blue_ghost_img = pygame.image.load(resource_path('assets/pacman-blue-ghost.jpg'))
pink_ghost_img = pygame.image.load(resource_path('assets/pacman-pink-ghost.jpg'))
orange_ghost_img = pygame.image.load(resource_path('assets/pacman-orange-ghost.jpg'))
red_ghost_img = pygame.image.load(resource_path('assets/pacman-red-ghost.jpg'))
